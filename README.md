...
| 初始筹码 | 每人 **10000** 起步 |
| All-in | 德州扑克新增 **All-in（封顶 1000）**：本人本局锁定不再加注，他人只能跟注/弃牌；全员决定后补满公共牌进入摊牌，最先 All-in 的玩家可先看 1 次或 2 次再比大小 |
| 看牌（逐张） | 两种玩法均**闷牌开局**，发牌后默认不看；可「看1张 / 看2张」逐张查看自己的牌 |
| 加注档位 | 加注金额新增档位 **50 / 100 / 200 / 500**（炸金花与德州通用） |
| 银行借款 | 筹码用完后随时向"银行"借款（每次 +1000，单人累计上限 10000），头像旁显示借款数额 |
...
**炸金花**：每人 3 张暗牌（闷牌开局）。可「看1张/看2张」逐张看牌；轮到自己可 跟注 / 加注(档位50·100·200·500) / 弃牌；
每人都行动过一轮后可"开牌"，所有未弃牌玩家比牌型：
豹子 > 顺金 > 金花 > 顺子 > 对子 > 散牌。

**德州扑克**：每人 2 张底牌 + 5 张公共牌，四轮下注（翻牌前/翻牌/转牌/河牌），
加注档位 50/100/200/500；支持 All-in（封顶1000，触发后本人锁定、他人只能跟注/弃牌，全员决定即补满公共牌摊牌，最先 All-in 者先看1/2次再比大小）。
